...
public class Count {
	...
	/*
	 # 인스턴스 메서드: 객체를 생성하여 주소값을 통해 접근한 후
	                호출하는 메서드 
       인스턴스 메서드 안에서는 정적(static) 변수와
       인스턴스 변수 모드를 참조할 수 있다. 
	 */
	public int method1() {
	...
	public static int method2() { //static-객체생성과 무관
		Count ccc = new Count(); //static안에서 this사용불가

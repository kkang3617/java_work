...
public class MyBirth {
	...
	/*
	 - 캡슐화는 데이터에 접근 제한을 걸어서 정보를 보호하는 것이
	   목적이지만 private를 설정하면 데이터 접근 자체가 불가능해짐.
	 ...
	 2. 메서드 내부에 데이터 유효성 검증 로직을 작성하여 적절한
	    데이터만 멤버변수에 저장시키고, 접근제한자는 public으로
	    설정하여 외부에서 누구나 사용할 수 있게 한다.
    ...
    */
	...
	public void setDay(int day) {
		if(day > 31 || day < 1) {
			System.out.println("잘못된 일 일력입니다.");
		} else {
			this.day = day;
		}
	}

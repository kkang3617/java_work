...
//		int score = 95;  (X)  중복!할당불가
		...
		int myScore = score - 20;    // 영역 = 값
		System.out.println(myScore);
		
		//변수의 자료형에 맞지 않는 데이터는 저장이 불가능합니다.
//		int count = "한번"; (X), 정수가 아니어서 불가
//		int count = 23.5; (X), 실수여서 불가
//		string str = 100; (X), 문자열 아니어서 불가
...
//		int result = myScore + num; (X), num선언x
		int result;
//		System.out.println(result); (X), 값이 없음

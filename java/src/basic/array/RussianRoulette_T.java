...
public class RussianRoulette_T {
	...
	public static void main(String[] args) {
        ...
        */
	    ...
	    //게임 인원 입력
		System.out.print("게임인원을 입력하세요(2~4명): ");
		...
		//싵탄 개수 입력(1미만이면 안되고, 5초과도 안됩니다 1~5
		System.out.print("\n실탄 개수(6 미만): ");
		int bullet = sc.nextInt();
		
		if(bullet < 1 || bullet > 5) {
			System.out.println("실탄의 수가 올바르지 않습니다. 게임을 종료합니다.");
			return;
		}
		//실탄을 탄창에 배치합니다.
		boolean[] bulletPos = new boolean[6]; // 난수 0~5
		...
		while(checkNum < bullet) { //실탄을 정확하게 장전한 횟수<입력한 실탄개수
			int position = (int) (Math.random()*bulletPos.length); //0~5난수
		...
		//또는 총알이 다 소비할 때 까지 게임을 진행해 주세요.
		//총알을 소모하면 true값을 false로 변경해 주세요.
		//사람이 한 명 아웃되면 배열의 크기를 줄여 주세요. while(true)

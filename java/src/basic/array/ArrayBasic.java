...
public class ArrayBasic {
	public static void main(String[] args ) {
		...
		//# 배열(array)
		//-> 같은 데이터 타입의 값을 집합 형태로 나열하기 위한 자료임.
...
//		arr = 65; (x)
		arr[0] = 65;
		arr[1] = 88;
		arr[2] = arr[0]; //arr[0] 의 값을 대입하여 arr[2] 저장한다.
		arr[3] = (int) 3.14; // 3으로 들어감.
//		arr[4] = "들어갈까용?"; (x)
		arr[4] = 100;
//		arr[5] = 77; (x) index 범위를 초과.
		...
		System.out.println(arr); //주소가 출력됨.
		System.out.println(Arrays.toString(arr)); // Arrays매서드 사용

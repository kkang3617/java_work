...
public class TextualExample {
	...
	public static void main(String[] args) {
		...
		char c1 = 'A'; // 'AB'불가 단일문자만 가능
		               // "A" 불가 ''만 가능
		System.out.println(c1);
		
		char c2 = 65;  // 아스키코드로 65는 A
		...
		String s1 = "my dream "; // "공백, 숫자" 모두 문자로 취급
		...
		System.out.println(s1 + s2);  // 문자열과 문자열의 연결은 덧셈만 가능.
		
		//문자열과 다른 데이터 타입 간의 연산 결과는~
		//무조건 문자열의 덧셈 연산과 같습니다.
		System.out.println("------------------------------------------------");

...
public class MethodExample2 {
	...
	/*
	 ...
	 5. 매개변수를 하나도 선언하지 않을 수도 있습니다. 이 때는 메서드의 선언부에
	   () 내부를 배워둡니다. 그리고 호출할 때도 ()를 비워서 호출합니다.
	 
	 */
	
	//x부터의 y까지의 누적합계를 구하는 메서드
	...
	//매개변수가 필요없는 경우
	static String selectRandomFood() {  //괄호 뺴먹지 말기.

...
public class HashSetExample {
	...
	public static void main(String[] args) {
		...
		/*
		 - set은 인덱스가 없기 때문에 메서드를 이용해서 객체를 얻는게
		   아니라 반복자 (Iterator)을 통해서 요소를 하나씩 꺼내봐야한다.

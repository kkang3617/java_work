...
public class ArrayListExample {
	...
	public static void main(String[] args) {
		...
		nick.add("짹짹이");
		nick.add("야옹이"); //중복저장 가능
		System.out.println(nick);
		
		//add(인덱스, 객체): 특정 인덱스의 객체를 삽입하는 메서드
		nick.add(3, "어흥이");
		System.out.println(nick);
...
//		isEmpty(): 리스트가 비어있는지의 여부 확인
		System.out.println(nick.isEmpty()); //닉이 비어있냐? true
		
		//# 컬렉션 객체들은 Collections의 기능을 사용할 수 있다.
		//  Collections는 컬렉션 객체들의 부가 기능을 지원한다.

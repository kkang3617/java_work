...
public class MultiCatchExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 - 다중 catch문은 실제로 에러가 발생하면 위에서부터 순서대로
			   catch문을 검색하면서 내려오기 때문에 부모 타입의 예외를 자식
			   타입의 예외보다 위에 작성하면 안된다!
			 
			 - catch 옆에 괄호에 예외 타입을 여러개 작성하고 싶은 경우는
			   | 기호를 사용하여 타입을 나열해 주면, 하나의 catch블록으로
			...
			System.out.println("null을 참조하면 우뚜케!!");
		} catch(Exception e) {
